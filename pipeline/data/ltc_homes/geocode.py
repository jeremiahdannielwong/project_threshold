"""Enrich brampton_ltc_homes.csv with lat/lon via Nominatim (OpenStreetMap).

Idempotent: rows that already have coordinates are skipped. Respects Nominatim's
1-request-per-second usage policy. Run once; the resulting coordinates are baked
into the CSV so the runtime pipeline has no dependency on Nominatim.

Usage:
    python pipeline/data/ltc_homes/geocode.py
"""
